\chapter{TPI applied to $\mathcal{P}(\mathbb{N})$ vs $\mathbb{N}$ }
	...
	\section{Building the TPI for our concrete case}
		...
		\noindent
		SECOND REQUISITE: we need a system of relations: the partition of FLJA\_abstract into $\aleph_{0}$ diferent $r_{\theta_{k}}$ relations fits the second one perfectly.
		\\\\
