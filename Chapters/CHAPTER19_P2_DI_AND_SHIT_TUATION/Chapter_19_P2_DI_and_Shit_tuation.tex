\chapter{DI and Shit-tuation}
	...
	\noindent
	ALL chops are previously defined: System of relations {\ref{tab: system_relations_r_theta_k}. \\\\
	...
	\noindent
	\textbf{Chops are independent}: if you do a chop for a particular D-pair, you don't need the previous chops to make it work.\\\\
	...
	If it ends EMPTY, we are saying that under the contenxt of the Shit-tuation, the special set "S" end TOTALLY EMPTY.
	\\\\
