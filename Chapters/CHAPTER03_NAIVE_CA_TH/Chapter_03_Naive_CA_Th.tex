\chapter{Naive CA Theorem}
	...
	\noindent
	When ALL PACKS has cardinal 1, we have exactly the case when r is an injective function. Naive CA Th. is a generalization, for the injectivity practical use, for relations that are not functions.
	\\\\
